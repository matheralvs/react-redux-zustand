...
describe("zustant store", () => {
  ...
  it("should be able next video automatically", () => {
    store.setState({
      course,
    });
  ...
  it("should be update the current module and lesson index if there is not next lesson available", () => {
    store.setState({ course });
