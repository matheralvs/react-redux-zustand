    ...
    <div className="flex h-screen items-center justify-center bg-zinc-950 text-zinc-50">
      <div className="flex w-[1100px] flex-col gap-6">
        ...
        <main className="relative flex overflow-hidden rounded-lg border border-zinc-800 bg-zinc-900 pr-80 shadow">
          ...
          <aside className="divide-zinc-7 absolute bottom-0 right-0 top-0 w-80 divide-y-2 divide-zinc-900 overflow-y-scroll border-l border-zinc-800 bg-zinc-900 scrollbar scrollbar-thin scrollbar-track-zinc-950 scrollbar-thumb-violet-500">
            <div>
              <button className="flex w-full items-center gap-3 bg-zinc-800 p-4">
                ...
                <div className="flex flex-col gap-1 text-left">
                  <strong className="text-sx">Desvendando o Redux</strong>
                  <span className="text-sx text-zinc-400">12 Aulas</span>
                </div>
